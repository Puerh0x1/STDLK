...
(function(window){
    ...
    function lignePaginate(){
        ...
        var pageButtons = function(numberOfPage,currentPage) {
             ...
             **/
            let buttons = "<input type='button' value='← пред' class='paginate_control_prev' onclick='paginate.sort("+(currentPage - 1)+")' "+prevDisabled+">";
            ...
            let nextButton = "<input type='button' value='след →' class='paginate_control_next' onclick='paginate.sort("+(currentPage + 1)+")' "+nextDisabled+">";
            buttons +=  nextButton;
